...
package ztc1997.gxmu.teachingassessment.adapter;
...
public class EmptyAdapter extends RecyclerView.Adapter<EmptyAdapter.EmptyViewHolder> {
    ...
    public EmptyAdapter(Activity activity) {
        this.activity = activity;
    }

    @Override
    public EmptyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = activity.getLayoutInflater().inflate(R.layout.view_overlay_progress, parent, false);
